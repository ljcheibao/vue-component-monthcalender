...
var MonthCalender = /** @class */ (function (_super) {
    ...
    MonthCalender.prototype.renderCalenderView = function (date, isRight, isSwiper) {
        ...
        if (isSwiper === void 0) { isSwiper = false; }
            ...
            for (var _d = 0, _e = _this.monthCalender.monthDayList; _d < _e.length; _d++) {
                ...
                if (item.currentMonth == currentMonth) {
                    for (var _f = 0, _g = item.dayList; _f < _g.length; _f++) {
                        ...
                        if (!item1.dayDesc)
                            continue;
                        if (item1.currentDate != Utils.dateFormat("yyyy-MM-dd", currentDate))
                            continue;
    ...
    MonthCalender.prototype.chooseDayHandle = function (dayItem, currentMonth, event) {
        ...
        if (!event)
            return true;
        if (!dayItem.dayDesc && dayItem.dayClass == "day")
            return true;
        var _this = this;
    ...
    ], MonthCalender.prototype, "option", void 0);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_vue_property_decorator__["a" /* Prop */])(),
        __metadata("design:type", Boolean)
    ], MonthCalender.prototype, "value", void 0);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_vue_property_decorator__["b" /* Watch */])("value"),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object]),
        __metadata("design:returntype", void 0)
    ], MonthCalender.prototype, "watchValueChange", null);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_vue_property_decorator__["c" /* Emit */])("on-slide"),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [String, Boolean]),
        __metadata("design:returntype", void 0)
    ], MonthCalender.prototype, "swipeSlideHandle", null);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_vue_property_decorator__["c" /* Emit */])("on-click"),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [typeof (_b = (typeof __WEBPACK_IMPORTED_MODULE_3__CalenderModel__["a" /* Calender */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__CalenderModel__["a" /* Calender */]).DayModel) === "function" && _b || Object, String, Object]),
        __metadata("design:returntype", Object)
    ], MonthCalender.prototype, "chooseDayHandle", null);
    MonthCalender = __decorate([
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Calender; });
/**
 * 日历组件相关的数据模块
 * @namespace
 */
...
var _vueComponentMonthcalender = __webpack_require__(1);

var _vueComponentMonthcalender2 = _interopRequireDefault(_vueComponentMonthcalender);
...
new _vue2.default({
  el: '#app',
  components: {
    VueMcalender: _vueComponentMonthcalender2.default
  },
  data: function data() {
    return {
      visible: true,
